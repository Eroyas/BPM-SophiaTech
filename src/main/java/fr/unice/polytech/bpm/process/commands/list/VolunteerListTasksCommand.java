...
public class VolunteerListTasksCommand implements Command {

    private static final String VOLUNTEER_ID = "volunteer";
    ...
    public void execute(ProcessEngine context) {
        ...
        List<Task> tasks = taskService.createTaskQuery().taskCandidateGroup(VOLUNTEER_ID).list();
